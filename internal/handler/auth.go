...
// Accounts are created by administrators; self-registration is not allowed.
...
// The user must provide a unique username and a nickname.
...
// PasswordHash hashes a plaintext password for storage.
